    ...
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
      ...
      <form @submit.prevent="changePassword" class="space-y-6">
        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            <input v-model="newPassword" :type="showNewPassword ? 'text' : 'password'" id="newPassword"
              ...
              required placeholder="Entrez votre nouveau mot de passe" />
    ...
    <div
      ...
      <div class="text-center">
        ...
        <p class="text-gray-600 mb-8 leading-relaxed">
          Votre mot de passe a été modifié avec succès. Vous allez être redirigé vers la page de connexion dans quelques
          secondes.
        </p>
