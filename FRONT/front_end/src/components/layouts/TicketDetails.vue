        ...
        <div v-for="(message, index) in messages" :key="message._id">
          ...
          <div :class="[
            ...
            <div v-if="message.isDescription && ticket.file" class="mt-2">
              <a :href="`/uploads/documents/${ticket.file}`" :download="ticket.file"
                class="text-blue-500 hover:underline flex items-center" @click.prevent="downloadFile">
            ...
            <div class="flex items-center justify-end">
              <!-- Bouton Répondre -->
              <button v-if="message.isDescription || message.userId?._id !== currentUserId"
            ...
            <!-- Popup d'erreur -->
            <div v-if="showClosedTicketError"
              class="fixed inset-0 bg-gray-500 bg-opacity-10 flex justify-center items-center">
              <div class="bg-white rounded-lg p-6 w-1/4 shadow-md relative text-center">
                ...
                <button @click="showClosedTicketError = false"
