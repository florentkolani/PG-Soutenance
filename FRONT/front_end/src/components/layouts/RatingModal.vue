  ...
  <div>
    ...
    <div v-if="showModal" class="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div class="bg-white p-8 rounded-lg shadow-2xl w-96 relative transform transition-all duration-300 scale-100">
        <button @click="close" class="absolute top-3 right-3 text-gray-400 hover:text-gray-600 transition-colors duration-200">
        ...
        <form @submit.prevent="submitRating" class="space-y-6">
          <div>
            ...
            <select v-model="rating.note" required class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all duration-200">
          ...
          <div v-if="rating.note === 'Médiocre' || rating.note === 'Passable'" 
            ...
            <textarea 
              ...
              placeholder="Veuillez expliquer la raison de votre insatisfaction..."
            ></textarea>
          </div>
    ...
    <div v-if="showAlert" class="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div class="bg-white p-6 rounded-lg shadow-xl w-80 text-center transform transition-all duration-300 scale-100 relative">
