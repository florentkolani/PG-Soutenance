<template>
  <div class="flex h-screen">
    ...
    <aside :aria-expanded="sidebarVisible" :class="[
      'bg-white w-64 p-6 border-r shadow-lg fixed md:relative h-screen z-20 transition-transform duration-300 overflow-y-auto',
      ...
      <nav class="space-y-2">
        <ul class="space-y-1 list-none p-0">
          ...
          <li v-for="module in filteredModules" :key="module.name" class="w-full">
            <router-link :to="module.route" :class="[
              ...
              <svg v-else-if="module.name === 'Pays'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3"
                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
