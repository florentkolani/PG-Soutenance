    ...
    <div class="overflow-y-auto py-5 px-3 h-full border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      <ul class="pt-4 mt-11 space-y-2 border-t border-gray-200 dark:border-gray-700">
        ...
        <li >
         ...
         <li >
          <router-link to="/SendEmail" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray- 100 dark:text-white dark:hover:bg-gray-700">
          </router-link>
        </li> 
        <li>
      ...
      <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
        ...
        <li>
          <router-link to="/Apropos" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
          </router-link>
        </li>
      </ul>
    </div>
