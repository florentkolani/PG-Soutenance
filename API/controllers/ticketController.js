...
//     } catch (error) {
//         res.status(400).json({ message: 'Erreur lors de la création du ticket', error });
//     }
// };
...
//     } catch (error) {
//         res.status(400).json({ message: 'Erreur lors de la mise à jour du ticket', error });
//     }
// };
...
//     try {
//         const ticket = await Ticket.findByIdAndUpdate(req.params.id, { statut: 'Fermé' }, { new: true });
//         if (!ticket) {
//             return res.status(404).json({ message: 'Ticket non trouvé' });
//         }
//         res.status(200).json(ticket);
//     } catch (error) {
//         res.status(400).json({ message: 'Erreur lors de la fermeture du ticket', error });
//     }
// };
